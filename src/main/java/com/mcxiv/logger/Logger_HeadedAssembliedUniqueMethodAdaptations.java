...
class Logger_HeadedAssembliedUniqueMethodAdaptations extends Logger_HeadedAssemblyConsumerMachine {

    public Logger_HeadedAssembliedUniqueMethodAdaptations(OutputStream stream) {
        super(stream);
    }

    public Logger_HeadedAssembliedUniqueMethodAdaptations() {
        super();
    }

    public Logger_HeadedAssembliedUniqueMethodAdaptations(ByteConsumer consumer) {
        super(consumer);
    }
