...
abstract class Logger_SimpleFormatConsumerMachine extends Logger_PrintingMethodAdder {
    ...
    public Logger_SimpleFormatConsumerMachine(OutputStream stream) {
        super(stream);
        initialise();
    }

    public Logger_SimpleFormatConsumerMachine() {
        super();
        initialise();
    }

    public Logger_SimpleFormatConsumerMachine(ByteConsumer consumer) {
        super(consumer);
        initialise();
    }

    public void initialise() {
        initialise(Configuration.getSimpleFormatDefault());
    }
