...
class Logger_DoubleFormattedUniqueMethodAdaptations extends Logger_DoubleFormatConsumerMachine {

    public Logger_DoubleFormattedUniqueMethodAdaptations(OutputStream stream) {
        super(stream);
    }

    public Logger_DoubleFormattedUniqueMethodAdaptations() {
        super();
    }

    public Logger_DoubleFormattedUniqueMethodAdaptations(ByteConsumer consumer) {
        super(consumer);
    }
    ...
    public void status(String... i) {
        ...
        last_length = 10 + joiner.length() - last_length;
    }
