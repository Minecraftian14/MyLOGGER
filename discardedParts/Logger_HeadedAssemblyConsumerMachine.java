...
abstract class Logger_HeadedAssemblyConsumerMachine extends Logger_PrintingMethodAdder {
    ...
    public Logger_HeadedAssemblyConsumerMachine(OutputStream stream) {
        super(stream);
        initialise();
    }

    public Logger_HeadedAssemblyConsumerMachine() {
        super();
        initialise();
    }

    public Logger_HeadedAssemblyConsumerMachine(ByteConsumer consumer) {
        super(consumer);
        initialise();
    }

    public void initialise() {
        initialise(Configuration.getHeadedPrependableDefault());
    }
